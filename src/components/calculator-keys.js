...
class CalculatorKeys extends PageViewElement {
  _render(props) {
    return html`
      ${SharedStyles}
      <section>
        <h2>Tape</h2>
        <p>
	  This page shows the keyboard mappings for the calculator.
	</p>
      </section>
    `
  }
...
window.customElements.define('calculator-keys', CalculatorKeys);
